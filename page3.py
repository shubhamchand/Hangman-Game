...
labelDesc = Label(frame, text="**Enter the word for second player to guess along with a relevent hint**",fg="red")
labelDesc.pack(side = BOTTOM)
label = Label(frame, text = "PLAYER 1", font=("bold"))
